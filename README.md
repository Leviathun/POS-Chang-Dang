...
- Supports two authorization levels:
  - **Admin (Owner)**: Full access to POS, settings, reports, menus, bulk stock adjustments, and cash drawer settings.
  - **Staff (Employee)**: Access to the POS checkout interface, stock viewing, and expense logging for their assigned branch.
...
4. Seeds default users (Admin/Owner and Staff). Refer to database configuration files for the default seed values.
